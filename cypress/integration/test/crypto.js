...
describe("Web Portal Test", () => {
    ...
    it.only("Test cypress", () => {
      ...
      //Marketplace search one card and compare its' price
      ...
      .should(($price) => {
        expect($price).to.have.text('999,999,999');
      });
    });
  });